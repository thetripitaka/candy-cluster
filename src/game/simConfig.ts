...
export const PAY_BANDS = [
  ...
  { min: 5,  max: 6,  L:[0.30,0.40,0.55,0.75], H:[0.32,0.42,0.58,0.75,0.95] },
  { min: 7,  max: 8,  L:[0.60,0.80,1.10,1.50], H:[0.55,0.75,1.05,1.40,1.80] },
  { min: 9,  max:10,  L:[0.95,1.25,1.80,2.40], H:[0.95,1.40,2.00,2.80,3.60] },
  { min:11,  max:12,  L:[1.70,2.30,3.20,4.20], H:[2.00,3.10,4.60,6.80,8.80] },
  { min:13,  max:15,  L:[3.20,4.20,6.00,7.80], H:[4.20,6.80,10.5,15.0,19.0] },
  { min:16,  max:19,  L:[6.20,8.20,11.8,15.2], H:[9.00,15.0,24.0,36.0,46.0] },
  { min:20,  max:999, L:[12.0,16.5,24.0,32.0], H:[18.0,30.0,55.0,95.0,120.0] },
] as const;
